...
import com.example.recyclerviewcontactlist.databinding.ItemUserBinding
...
class UsersAdapter(
    ...
    var users: List<User> = emptyList()
        set(newValue) {
            val diffCallback = UserDiffUtilsCallback(field, newValue)
    ...
    override fun onBindViewHolder(holder: UsersViewHolder, position: Int) {
        ...
        with(holder.binding) {
            ...
            userCompanyTextView.text =
                user.company.ifBlank { context.getString(R.string.remove) }
    ...
    private fun showPopupMenu(view: View) {
        ...
        if (user.company.isNotBlank()) {
            popupMenu.menu.add(0, ID_FIRE, Menu.NONE, context.getString(R.string.remove))
        }
